  ...
  const problemSolutions = [
    {
      ...
      solution: 'Standar Keselamatan Teruji & Perlengkapan Standar Internasional',
      desc: 'Setiap perahu dikawal pemandu bersertifikasi resmi dengan rescue team siaga, helm standar keselamatan, rompi pelampung daya apung tinggi, dan perlindungan asuransi penuh.',
      icon: (
