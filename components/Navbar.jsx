    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex justify-between items-center">
                ...
                return (
                  <li key={link.href}>
                    <a
                      ...
                      className={`text-[11px] lg:text-xs uppercase tracking-wider font-semibold whitespace-nowrap transition-all duration-200 no-underline px-3 lg:px-3.5 py-1.5 rounded-full ${
                        isActive
          ...
          {/* Right Action: Tombol WA di Laptop & Tombol Garis 3 HANYA di HP */}
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 z-[99999] md:hidden">
          ...
          <div className="fixed top-0 right-0 w-84 max-w-[88vw] h-full bg-white text-neutral-900 p-6 shadow-2xl flex flex-col justify-between border-l border-neutral-200 z-10 overflow-y-auto">
            ...
            {/* Quick Contact Buttons inside Drawer (Monochrome Luxury Theme) */}
            <div className="pt-5 border-t border-neutral-100 space-y-2.5 font-sans">
              <span className="text-[11px] font-bold text-neutral-400 uppercase tracking-widest block px-1">
